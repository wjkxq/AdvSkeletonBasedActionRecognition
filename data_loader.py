...
def fetch_dataloader(types, params):
    ...
    if 'NTU-RGB-D' in params.dataset_name:
        if 'CV' in params.dataset_name:
            params.train_feeder_args["data_path"] = params.dataset_dir+'/xview/train_data.npy'
            ...
            params.test_feeder_args["data_path"] = params.dataset_dir + '/xview/val_data.npy'
            # params.test_feeder_args["data_path"] = 'experiments/NTU-RGB-D-CV/HCN01/beta_10_untargeted_adv_data.npz'
        ...
        if 'CS' in params.dataset_name:
            params.train_feeder_args["data_path"] = params.dataset_dir + '/xsub/train_data.npy'
            ...
            # params.test_feeder_args["data_path"]= params.dataset_dir + '/xsub/val_data.npy'
            params.test_feeder_args["data_path"] = 'experiments/NTU-RGB-D-CS/sgn01/beta_10_untargeted_adv_data.npz'
    ...
    if types == 'train':
        ...
        loader = torch.utils.data.DataLoader(
            ...
            shuffle=True,
            num_workers=params.num_workers,pin_memory=params.cuda, drop_last=True)
